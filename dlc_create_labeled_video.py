...
dlc.create_labeled_video(config=config_path, videos=videos_path_list[listindex1:listindex2], videotype='.mp4', shuffle=shuffleindex, trainingsetindex=0, filtered=False, save_frames=True, Frames2plot=None, delete=True, displayedbodyparts='all', codec='mp4v', outputframerate=None, destfolder=None, draw_skeleton=True, trailpoints=0, displaycropped=False)
